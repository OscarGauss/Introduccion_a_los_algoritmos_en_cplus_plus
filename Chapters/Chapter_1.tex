...
\tab{ptrstr->codigo} \tab{articulo.codigo} \tab{(*ptrstr).codigo}
\\
\end{tabular}


\subsubsection{Operadores Lógicos y de Desplazamiento de Bits}\index{Lo mas basico!Operadores!Operadores Lógicos y de Desplazamiento de Bits}
