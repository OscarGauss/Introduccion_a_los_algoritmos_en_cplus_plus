...
\begin{lstlisting}[textcl=true,style=Cpp, label=factrec, caption=Factorial Recursivo]
#include <iostream>  
using namespace std;
...
\begin{lstlisting}[textcl=true,style=Cpp, label=fibo, caption=Sucesion Fibonacci]
#include <iostream>  
using namespace std;
